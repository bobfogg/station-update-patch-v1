...
cd /home/pi
cat > /home/pi/base_station.js <<- 'EOM'
...
export { BaseStation };
EOM
echo 'moving base_station.js'
chown pi:pi /home/pi/base_station.js
mv /home/pi/base_station.js /home/pi/ctt/station-radio-interface/src/server/base_station.js

cat > /home/pi/uploader.js <<- 'EOM'
...
export { Uploader };
EOM
chown pi:pi /home/pi/uploader.js
mv /home/pi/uploader.js /home/pi/ctt/station-radio-interface/src/server/uploader.js

cd /home/pi/ctt/station-radio-interface
